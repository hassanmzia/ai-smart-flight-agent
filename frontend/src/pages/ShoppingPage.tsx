...
const ShoppingPage = () => {
  ...
  return (
    <div className="min-h-screen">
      <div className="relative overflow-hidden bg-gradient-to-br from-pink-500 via-rose-500 to-red-600 dark:from-pink-800 dark:via-rose-800 dark:to-red-800">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute -top-10 -right-20 w-64 h-64 bg-white rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-1/4 w-40 h-40 bg-pink-300 rounded-full blur-3xl"></div>
        </div>
