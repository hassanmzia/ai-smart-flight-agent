...
_database_url = os.environ.get(
    'DATABASE_URL',
    'postgresql://travel_admin:travel_secure_pass_2026@localhost:5432/travel_agent_db'
)
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'travel_agent.pagination.ItemsPageNumberPagination',
    'PAGE_SIZE': 20,
