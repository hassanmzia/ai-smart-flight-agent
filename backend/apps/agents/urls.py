...
urlpatterns = [
    ...
    path('stories/react', react_story, name='react_story'),
    path('stories/comment', add_story_comment, name='add_story_comment'),
    path('stories/comments/<int:comment_id>', delete_story_comment, name='delete_story_comment'),
    ...
    path('templates/react', react_template, name='react_template'),
    path('templates/comments', template_comments, name='template_comments'),
    path('templates/comments/<int:comment_id>', delete_template_comment, name='delete_template_comment'),
    ...
    path('content/comments', content_comments, name='content_comments'),
    path('content/comments/<int:comment_id>', delete_content_comment, name='delete_content_comment'),
